#Note: already done manually on thos laptop
...
#Full path on my computer: D:\Charles\Code\Evolved5G\ImmersionNetApp\src
#Base path when executing the script: D:\Charles\Installs\Git
evolved5g register-and-onboard-to-capif --config_file_full_path="./capif_registration.json"